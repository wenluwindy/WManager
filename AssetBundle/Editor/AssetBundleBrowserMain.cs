...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        [MenuItem("插件工具/AssetBundle浏览器", priority = 2050)]
        static void ShowWindow()
        {
            s_instance = null;
            instance.titleContent = new GUIContent("AssetBundle浏览器");
            instance.Show();
        }
        ...
        void ModeToggle()
        {
            ...
            string[] labels = new string[3] { "浏览", "打包", "检查" };
