...
namespace WManager.UI
{
    ...
    public class UIViewEditor : Editor
    {
        ...
        private readonly GUIContent onVisibleContent = new GUIContent("显示时", "视图加载、显示");
        private readonly GUIContent onInvisibleContent = new GUIContent("隐藏时", "视图卸载、隐藏");
        ...
        private const string visibleKey = "UIView显示折叠";
        private const string invisibleKey = "UIView隐藏折叠";
            ...
            if (EditorGUILayout.BeginFadeGroup(animBool.faded))
            {
                ...
                switch (menu)
                {
                    case Menu.Animation:
                        ...
                        GUILayout.BeginHorizontal();
                        GUILayout.Label("类型", GUILayout.Width(40f));
                        ...
                        switch (viewAnimation.type)
                        {
                            ...
                            case AnimationType.Animator:
                                GUILayout.BeginHorizontal();
                                GUILayout.Label("状态名称", GUILayout.Width(80f));
